"""
Django settings for still_mode_3 project.
...
ROOT_URLCONF = 'still_mode_3.urls'
...
WSGI_APPLICATION = 'still_mode_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "still_mode_3 API",
    "DESCRIPTION": "API documentation for still_mode_3 App",
    "VERSION": "v1",
}
